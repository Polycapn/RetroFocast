...
import com.example.polycap.RetroForeCast.helper.DayFormatter;
import com.example.polycap.RetroForeCast.helper.TemperatureFormatter;
import com.example.polycap.RetroForeCast.model.CurrentWeather;
import com.example.polycap.RetroForeCast.model.WeatherForecast;
import com.example.polycap.RetroForeCast.services.LocationService;
import com.example.polycap.RetroForeCast.services.WeatherService;
...
public  class WeatherFragment extends Fragment {
     ...
     * Weather Fragment.
     * <p/>
     * Displays the current weather as well as a 16 day forecast for our location. Data is loaded
     * from a web service.
     */
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        final WeatherForecastListAdapter adapter = new WeatherForecastListAdapter(
                new ArrayList<MainWeatherForecast>(), getActivity());
    ...
    private class WeatherForecastListAdapter extends ArrayAdapter {
        ...
        public WeatherForecastListAdapter(final List<MainWeatherForecast> mainWeatherForecasts,
                                          final Context context) {
            super(context, 0, mainWeatherForecasts);
        }
